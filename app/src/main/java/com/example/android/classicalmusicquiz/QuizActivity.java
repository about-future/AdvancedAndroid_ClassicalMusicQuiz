...
public class QuizActivity extends AppCompatActivity implements View.OnClickListener, Player.EventListener {
    ...
    private void showNotification(PlaybackStateCompat state) {
        ...
        notification.setContentTitle(getString(R.string.guess))
                .setContentText(getString(R.string.notification_text))
                .setContentIntent(contentPendingIntent)
                .setSmallIcon(R.mipmap.ic_launcher)
                .setLargeIcon(BitmapFactory.decodeResource(getResources(), R.drawable.question_mark))
    ...
    private void initializePlayer(Uri mediaUri) {
        if (mExoPlayer == null) {
            ...
            final String userAgent = Util.getUserAgent(this, "ClassicalMusicQuiz");
